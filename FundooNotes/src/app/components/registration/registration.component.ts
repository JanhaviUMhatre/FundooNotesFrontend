...
export class RegistrationComponent implements OnInit {
  ...
  ngOnInit() {
    // this.cart.cardsreg.subscribe(inforeg => this.inforeg = inforeg)
    ...
    getservice(){
      ...
      console.log("name service",this.servicename)
    }
  ...
  // service : [this.inforeg, Validators.required]
   
  });
    onSubmit(){
      console.log("registerrrrr",this.registrationForm.value);
